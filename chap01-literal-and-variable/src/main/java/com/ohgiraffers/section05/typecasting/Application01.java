...
public class Application01 {
    public static void main(String[] args){
        ...
        1. 자동형변환 =묵시적 형변환 : 컴파일러가 자동으로 수행해주는 타입변환
            ...
            1.2 정수는 실수로 자동 형 변환 돈다.
            1.3 문자형은 int 형으로 자동 형변환 된다.
            1.4 논리형은 형변환 규칙에서 제외된다.
        2. 강제형변환 =명시적 형변환 : 형변환 캐스트 연산자를 이용한 강제적으로 수행하는 형변환
        ...
        char ch1 = 'a';
        int charNumber = ch1;
        System.out.println("char Number : " + charNumber);
        ...
        int bb = 3;
        int cc;
        cc = Integer.parseInt(String.valueOf(aa));
